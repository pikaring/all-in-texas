...
各紹介ページ（rock-on-mj / ride-on-qc / reach-on-sanma / all-in-texas）で同じスクリプトを使い、
...
SITES = {
    ...
    'all-in-texas': dict(
        name='All in TEXAS', assets='assets',
        head=['降りるか、押すか。', '数字が教えてくれる。'],
        tag='勝率・アウツ・必要勝率が見える、初心者のためのテキサスホールデム。',
        url='pikaring.github.io/all-in-texas',
        paper=(251, 248, 243), ink=(31, 34, 38), muted=(134, 140, 150), accent=(214, 92, 52), glow=(246, 223, 201)),
}
S = SITES[REPO]
